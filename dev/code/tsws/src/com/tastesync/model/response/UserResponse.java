...
public class UserResponse implements Serializable {
    ...
    public void setList_fb_user_data(
        List<TSFacebookUserDataObj> list_fb_user_data) {
    ...
    public void setList_user_follow_data(
        List<TSUserProfileRestaurantsObj> list_user_follow_data) {
